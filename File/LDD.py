...
# 导入管理窗口模块
from manager_windows import AlarmService
from alarm_manager_window import AlarmManagerWindow
from memo_manager_window import MemoManagerWindow
from message_center_window import MessageCenterWindow
from manager_utils import load_alarms, load_memos, load_messages
...
class DynamicIsland:
    ...
    def open_settings(self):
        ...
        self.settings_window.title("动态岛监控设置")
        ...
        title_label = tk.Label(header_frame, text="动态岛监控系统设置", 
    ...
    def _create_display_content_card(self, parent):
        ...
        bat_frame.pack(fill=tk.X, pady=4)
    ...
    def _apply_display_content(self):
        ...
        if self.show_battery:
            self.bat_label.place(x=280, y=20)
        else:
            self.bat_label.place_forget()
    ...
    def _update_status_indicators(self):
        ...
        message_x = self.expanded_width - 80  # 距离右边45像素
